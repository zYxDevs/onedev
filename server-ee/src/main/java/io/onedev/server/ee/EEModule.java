...
import io.onedev.server.ee.subscription.DelegateSubscriptionManager;
...
public class EEModule extends AbstractPluginModule {
	...
	protected void configure() {
		...
		bind(SubscriptionManager.class).to(DelegateSubscriptionManager.class);
		bind(EESubscriptionManager.class);
