...
import static io.onedev.server.ee.pack.nuget.NugetPackSupport.TYPE;
...
public class NugetPackService implements PackService {
	...
	public void service(HttpServletRequest request, HttpServletResponse response, Long projectId, 
		...
		if (!subscriptionManager.isSubscriptionActive()) {
			logger.warn("This feature requires an active subscription. Visit https://onedev.io/pricing to get a 30 days free trial");
